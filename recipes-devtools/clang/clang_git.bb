...
PACKAGECONFIG[pgo] = "-DLLVM_ENABLE_PER_TARGET_RUNTIME_DIR=ON -DBOOTSTRAP_LLVM_BUILD_INSTRUMENTED=IR -DBOOTSTRAP_LLVM_ENABLE_LLD=ON -DBOOTSTRAP_BOOTSTRAP_LLVM_ENABLE_LTO=Thin -DCLANG_BOOTSTRAP_PASSTHROUGH='${PASSTHROUGH}' -DBOOTSTRAP_CLANG_BOOTSTRAP_PASSTHROUGH='${PASSTHROUGH}' -C ${S}/clang/cmake/caches/PGO.cmake,,,,,bootstrap"
...
OECMAKE_TARGET_COMPILE = "${@bb.utils.contains_any('PACKAGECONFIG', 'bootstrap pgo', 'stage2', 'all', d)}"
OECMAKE_TARGET_INSTALL = "${@bb.utils.contains_any('PACKAGECONFIG', 'bootstrap pgo', 'stage2-install', 'install', d)}"
BINPATHPREFIX = "${@bb.utils.contains('PACKAGECONFIG', 'pgo', '/tools/clang/stage2-instrumented-bins/tools/clang/stage2-bins', bb.utils.contains('PACKAGECONFIG', 'bootstrap', '/tools/clang/stage2-bins', '', d), d)}"
...
LLVM_ENABLE_RTTI;LLVM_ENABLE_EH;LLVM_BUILD_EXTERNAL_COMPILER_RT;\
...
LLDB_ENABLE_LUA;LLVM_ENABLE_LIBEDIT;LLDB_ENABLE_LIBEDIT;LLDB_PYTHON_RELATIVE_PATH;LLDB_PYTHON_EXE_RELATIVE_PATH;\
...
LLVM_BUILD_TOOLS;LLVM_USE_HOST_TOOLS;LLVM_CONFIG_PATH;LLVM_ENABLE_LLD;\
"
#
