...
export CLANG_TIDY:toolchain-clang = "${HOST_PREFIX}clang-tidy"
...
UNWINDLIB:riscv64 = "--unwindlib=libgcc"
UNWINDLIB:riscv32 = "--unwindlib=libgcc"
...
TARGET_CXXFLAGS:append:toolchain-clang = " ${LIBCPLUSPLUS}"
TUNE_CCARGS:append:toolchain-clang = " ${COMPILER_RT} ${LIBCPLUSPLUS}"
